...
class SiteAddNewPoint {
  ...
  get element() {
    if (!_classPrivateFieldGet(this, _element)) {
      _classPrivateFieldSet(this, _element, (0,_render__WEBPACK_IMPORTED_MODULE_2__.createElement)(this.template));
    }
...
/* harmony export */ });
/* harmony import */ var _utils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/utils.js");
...
const points = Array.from({
  length: COUNT
}, _mock_point_js__WEBPACK_IMPORTED_MODULE_8__.generatePoint);
...
(0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripEventsElement, new _view_site_trips_sort_view_js__WEBPACK_IMPORTED_MODULE_2__["default"]().element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
...
(0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(tripEventsListElement.element, new _view_site_add_new_point_view_js__WEBPACK_IMPORTED_MODULE_6__["default"](points[1]).element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
...
const createPoint = (pointsList, point) => {
  ...
  (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(pointsList, waypointTemplate.element, _render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
};
