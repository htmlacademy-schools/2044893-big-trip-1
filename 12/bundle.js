...
var _waypointTemplateComponent = /*#__PURE__*/new WeakMap();
...
class WaypointPresenter {
  constructor(waypointContainer, changeData, changeMode) {
    ...
    _classPrivateFieldInitSpec(this, _waypointTemplateComponent, {
      writable: true,
      value: null
    });
    ...
    _defineProperty(this, "init", waypoint => {
      const prevWaypointComponent = _classPrivateFieldGet(this, _waypointTemplateComponent);

      const prevEditPointComponent = _classPrivateFieldGet(this, _editPointComponent);

      _classPrivateFieldSet(this, _waypoint, waypoint);

      _classPrivateFieldSet(this, _waypointTemplateComponent, new _view_site_waypoint_view_js__WEBPACK_IMPORTED_MODULE_2__["default"](waypoint));
      ...
      _classPrivateFieldGet(this, _waypointTemplateComponent).editClickHandler(_classPrivateFieldGet(this, _editClick));

      _classPrivateFieldGet(this, _waypointTemplateComponent).favoriteClickHandler(_classPrivateFieldGet(this, _favoriteClick));
      ...
      if (prevWaypointComponent === null || prevEditPointComponent === null) {
        (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _waypointContainer), _classPrivateFieldGet(this, _waypointTemplateComponent), _render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.BEFOREEND);
        return;
      }

      if (_classPrivateFieldGet(this, _mode) === Mode.DEFAULT) {
        (0,_render__WEBPACK_IMPORTED_MODULE_0__.replace)(_classPrivateFieldGet(this, _waypointTemplateComponent), prevWaypointComponent);
      }
    ...
    _defineProperty(this, "destroy", () => {
      (0,_render__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _waypointTemplateComponent));
    ...
    _classPrivateFieldInitSpec(this, _replaceWaypointToForm, {
      writable: true,
      value: () => {
        (0,_render__WEBPACK_IMPORTED_MODULE_0__.replace)(_classPrivateFieldGet(this, _editPointComponent), _classPrivateFieldGet(this, _waypointTemplateComponent));
    ...
    _classPrivateFieldInitSpec(this, _replaceFormToWaypoint, {
      writable: true,
      value: () => {
        (0,_render__WEBPACK_IMPORTED_MODULE_0__.replace)(_classPrivateFieldGet(this, _waypointTemplateComponent), _classPrivateFieldGet(this, _editPointComponent));
...
class TripPresenter {
  constructor(tripEventsContainer) {
    ...
    _defineProperty(this, "waypointElement", null);
    ...
    _defineProperty(this, "init", points => {
      ...
      _classPrivateFieldGet(this, _renderPoint).call(this);
    });
    ...
    _classPrivateFieldInitSpec(this, _handlePointChange, {
      writable: true,
      value: updatedPoint => {
        _classPrivateFieldSet(this, _points, (0,_utils_js__WEBPACK_IMPORTED_MODULE_1__.updateItem)(_classPrivateFieldGet(this, _points), updatedPoint));
    ...
    _classPrivateFieldSet(this, _tripEventsElement, _classPrivateFieldGet(this, _tripEventsContainer).querySelector('.trip-events'));
  }
