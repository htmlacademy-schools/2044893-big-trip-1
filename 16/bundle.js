...
class FilterModel extends _utils_utils_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    super(...args);

    _classPrivateFieldInitSpec(this, _filter, {
      writable: true,
      value: _utils_utils_js__WEBPACK_IMPORTED_MODULE_0__.FilterType.EVERYTHING
    });
...
class PointsModel extends _utils_utils_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(...args) {
    super(...args);
...
/* harmony export */ });
/* harmony import */ var _view_site_trips_filters_view_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/site-trips-filters-view.js */ "./src/view/site-trips-filters-view.js");
...
var _ModelEvent = /*#__PURE__*/new WeakMap();

var _FilterTypeChange = /*#__PURE__*/new WeakMap();
...
class FilterPresenter {
  constructor(filterContainer, filterModel, tasksModel) {
    ...
    _defineProperty(this, "init", () => {
      ...
      const previousFilter = _classPrivateFieldGet(this, _filterComponent);

      _classPrivateFieldSet(this, _filterComponent, new _view_site_trips_filters_view_js__WEBPACK_IMPORTED_MODULE_0__["default"](filters, _classPrivateFieldGet(this, _filterModel).filter));

      _classPrivateFieldGet(this, _filterComponent).FilterTypeChangeHandler(_classPrivateFieldGet(this, _FilterTypeChange));
      ...
      (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.replace)(_classPrivateFieldGet(this, _filterComponent), previousFilter);
      (0,_render_js__WEBPACK_IMPORTED_MODULE_1__.remove)(previousFilter);
    });

    _classPrivateFieldInitSpec(this, _ModelEvent, {
      writable: true,
      value: () => {
        this.init();
      }
    ...
    _classPrivateFieldInitSpec(this, _FilterTypeChange, {
      writable: true,
      value: filterType => {
        ...
        _classPrivateFieldGet(this, _filterModel).setFilter(_utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.UpdateType.MAJOR, filterType);
      }
    });
    ...
    _classPrivateFieldGet(this, _filterModel).addObserver(_classPrivateFieldGet(this, _ModelEvent));
  }
...
/* harmony import */ var _view_site_add_new_point_view_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/site-add-new-point-view.js */ "./src/view/site-add-new-point-view.js");
/* harmony import */ var nanoid__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! nanoid */ "./node_modules/nanoid/index.browser.js");
/* harmony import */ var _utils_utils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/utils.js */ "./src/utils/utils.js");
function _defineProperty(obj, key, value) { if (key in obj) { Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true }); } else { obj[key] = value; } return obj; }
...
var _pointsList = /*#__PURE__*/new WeakMap();

var _changeData = /*#__PURE__*/new WeakMap();

var _addPointItem = /*#__PURE__*/new WeakMap();

var _FormSubmit = /*#__PURE__*/new WeakMap();

var _DeleteClick = /*#__PURE__*/new WeakMap();

var _escKeyDown = /*#__PURE__*/new WeakMap();

class NewPointPresenter {
  constructor(pointsList, changeData) {
    _classPrivateFieldInitSpec(this, _pointsList, {
      writable: true,
      value: null
    });
    ...
    _classPrivateFieldInitSpec(this, _addPointItem, {
      writable: true,
      value: null
    });

    _defineProperty(this, "init", () => {
      if (_classPrivateFieldGet(this, _addPointItem) !== null) {
        return;
      }

      _classPrivateFieldSet(this, _addPointItem, new _view_site_add_new_point_view_js__WEBPACK_IMPORTED_MODULE_1__["default"]());

      _classPrivateFieldGet(this, _addPointItem).FormSubmitHandler(_classPrivateFieldGet(this, _FormSubmit));

      _classPrivateFieldGet(this, _addPointItem).DeleteClickHandler(_classPrivateFieldGet(this, _DeleteClick));

      (0,_render__WEBPACK_IMPORTED_MODULE_0__.render)(_classPrivateFieldGet(this, _pointsList), _classPrivateFieldGet(this, _addPointItem), _render__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
      document.addEventListener('keydown', _classPrivateFieldGet(this, _escKeyDown));
    });
    ...
    _defineProperty(this, "destroy", () => {
      ...
      (0,_render__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _addPointItem));

      _classPrivateFieldSet(this, _addPointItem, null);

      document.removeEventListener('keydown', _classPrivateFieldGet(this, _escKeyDown));
    });

    _classPrivateFieldInitSpec(this, _FormSubmit, {
      writable: true,
      value: task => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.UserAction.ADD_POINT, _utils_utils_js__WEBPACK_IMPORTED_MODULE_2__.UpdateType.MINOR, {
          id: (0,nanoid__WEBPACK_IMPORTED_MODULE_3__.nanoid)(),
          ...task
        });
    ...
    _classPrivateFieldInitSpec(this, _DeleteClick, {
      writable: true,
      value: () => {
        this.destroy();
      }
    ...
    _classPrivateFieldInitSpec(this, _escKeyDown, {
      writable: true,
      value: evt => {
    ...
    _classPrivateFieldSet(this, _pointsList, pointsList);
...
class WaypointPresenter {
  constructor(waypointContainer, changeData, changeMode) {
    ...
    _defineProperty(this, "init", waypoint => {
      ...
      _classPrivateFieldGet(this, _editPointComponent).deleteClickHandler(_classPrivateFieldGet(this, _deleteClick));
    ...
    _classPrivateFieldInitSpec(this, _formSubmit, {
      writable: true,
      value: update => {
        const isMinorUpdate = !(0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.dateEquality)(_classPrivateFieldGet(this, _waypoint).dateFrom, update.dateFrom) || !(0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.dateEquality)(_classPrivateFieldGet(this, _waypoint).dateTo, update.dateTo) || _classPrivateFieldGet(this, _waypoint).cost !== update.cost;

        _classPrivateFieldGet(this, _changeData).call(this, _utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_POINT, isMinorUpdate ? _utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR : _utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.PATCH, update);
    ...
    _classPrivateFieldInitSpec(this, _favoriteClick, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.UPDATE_POINT, _utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, { ..._classPrivateFieldGet(this, _waypoint),
    ...
    _classPrivateFieldInitSpec(this, _deleteClick, {
      writable: true,
      value: task => {
        _classPrivateFieldGet(this, _changeData).call(this, _utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.UserAction.DELETE_POINT, _utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.UpdateType.MINOR, task);
      }
    });
...
/* harmony import */ var _view_site_event_list_view_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/site-event-list-view.js */ "./src/view/site-event-list-view.js");
...
/* harmony import */ var _view_site_add_first_point_view_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/site-add-first-point-view.js */ "./src/view/site-add-first-point-view.js");
/* harmony import */ var _new_point_presenter_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./new-point-presenter.js */ "./src/presenter/new-point-presenter.js");
...
class TripPresenter {
  ...
  constructor(mainElement, pointsModel, filterModel) {
    ...
    _classPrivateFieldInitSpec(this, _tripEventsListElement, {
      writable: true,
      value: new _view_site_event_list_view_js__WEBPACK_IMPORTED_MODULE_1__["default"]()
    });
    ...
    _classPrivateFieldInitSpec(this, _currentSortType, {
      writable: true,
      value: _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_DAY
    });

    _classPrivateFieldInitSpec(this, _filterType, {
      writable: true,
      value: _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.FilterType.EVERYTHING
    });
    ...
    _defineProperty(this, "createPoint", () => {
      _classPrivateFieldSet(this, _currentSortType, _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_DAY);

      _classPrivateFieldGet(this, _filterModel).setFilter(_utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.UpdateType.MAJOR, _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.FilterType.EVERYTHING);

      _classPrivateFieldGet(this, _newPointPresenter).init();
    });
    ...
    _classPrivateFieldInitSpec(this, _handleModelEvent, {
      ...
      value: (updateType, data) => {
        switch (updateType) {
          case _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.UpdateType.PATCH:
            _classPrivateFieldGet(this, _pointPresenter).get(data.id).init(data);

            break;

          case _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.UpdateType.MINOR:
          ...
          case _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.UpdateType.MAJOR:
            _classPrivateFieldGet(this, _clearMain).call(this, {
    ...
    _classPrivateFieldInitSpec(this, _renderFirstPoint, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _siteAddFirstComponent, new _view_site_add_first_point_view_js__WEBPACK_IMPORTED_MODULE_4__["default"](_classPrivateFieldGet(this, _filterType)));
    ...
    _classPrivateFieldInitSpec(this, _handleViewAction, {
      ...
      value: (actionType, updateType, update) => {
        switch (actionType) {
          case _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.UserAction.UPDATE_POINT:
            _classPrivateFieldGet(this, _pointsModel).updatePoint(updateType, update);

            break;

          case _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.UserAction.ADD_POINT:
            _classPrivateFieldGet(this, _pointsModel).addPoint(updateType, update);

            break;

          case _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.UserAction.DELETE_POINT:
    ...
    _classPrivateFieldInitSpec(this, _handleModeChange, {
      writable: true,
      value: () => {
        _classPrivateFieldGet(this, _newPointPresenter).destroy();
    ...
    _classPrivateFieldInitSpec(this, _renderSort, {
      writable: true,
      value: () => {
        _classPrivateFieldSet(this, _tripSortComponent, new _view_site_trips_sort_view_js__WEBPACK_IMPORTED_MODULE_2__["default"](_classPrivateFieldGet(this, _currentSortType)));
    ...
    _classPrivateFieldInitSpec(this, _renderPoint, {
      writable: true,
      value: point => {
        const pointPresenter = new _point_presenter_js__WEBPACK_IMPORTED_MODULE_3__["default"](_classPrivateFieldGet(this, _tripEventsListElement), _classPrivateFieldGet(this, _handleViewAction), _classPrivateFieldGet(this, _handleModeChange));
    ...
    _classPrivateFieldInitSpec(this, _clearMain, {
      ...
      value: ({
        ...
        (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _tripSortComponent));

        if (resetSortType) {
          _classPrivateFieldSet(this, _currentSortType, _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_DAY);
        }

        if (_classPrivateFieldGet(this, _siteAddFirstComponent)) {
          (0,_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(_classPrivateFieldGet(this, _siteAddFirstComponent));
        }
      }
    });
    ...
    _classPrivateFieldSet(this, _newPointPresenter, new _new_point_presenter_js__WEBPACK_IMPORTED_MODULE_5__["default"](_classPrivateFieldGet(this, _tripEventsListElement), _classPrivateFieldGet(this, _handleViewAction)));
  ...
  get points() {
    ...
    const filteredPoints = _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.filter[_classPrivateFieldGet(this, _filterType)](points);

    switch (_classPrivateFieldGet(this, _currentSortType)) {
      case _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_DAY:
        return filteredPoints.sort(_utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.sortPointByDay);

      case _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_TIME:
        return filteredPoints.sort(_utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.sortPointByDuration);

      case _utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.SortType.SORT_PRICE:
        return filteredPoints.sort(_utils_utils_js__WEBPACK_IMPORTED_MODULE_6__.sortPointByPrice);
    }
...
/* harmony export */   "dateEquality": () => (/* binding */ dateEquality),
...
const dateEquality = (dateA, dateB) => dateA === null && dateB === null || dayjs__WEBPACK_IMPORTED_MODULE_0___default()(dateA).isSame(dateB);
const SortType = {
  SORT_DAY: 'sort-day',
  SORT_TIME: 'sort-time',
...
const addFirstPointTextType = {
  [_utils_utils_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.EVERYTHING]: 'Click New Event to create your first point',
  [_utils_utils_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.PAST]: 'There are no past events now',
  [_utils_utils_js__WEBPACK_IMPORTED_MODULE_1__.FilterType.FUTURE]: 'There are no future events now'
};
...
const createAddNewPointTemplate = point => {
  ...
  const pointTypesMarkup = (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.createWaypointTypesMarkup)((0,_utils_offers_js__WEBPACK_IMPORTED_MODULE_2__.offersList)(), type);
  ...
  const editedOffersMarkup = (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.createOffersSegmentMarkup)((0,_utils_offers_js__WEBPACK_IMPORTED_MODULE_2__.offersList)(), type);
...
var _dateFromChange = /*#__PURE__*/new WeakMap();

var _dateToChange = /*#__PURE__*/new WeakMap();
...
var _costChange = /*#__PURE__*/new WeakMap();

var _formSubmit = /*#__PURE__*/new WeakMap();

var _formDeleteClick = /*#__PURE__*/new WeakMap();

var _getChangedDestination = /*#__PURE__*/new WeakMap();

class SiteAddNewPoint extends _smart_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(_point) {
    super();
    ...
    _defineProperty(this, "reset", point => {
      this.updateData(SiteAddNewPoint.parsePointToData(point));
    });
    ...
    _classPrivateFieldInitSpec(this, _setDatepicker, {
      ...
      value: () => {
        _classPrivateFieldSet(this, _datepickerFrom, (0,flatpickr__WEBPACK_IMPORTED_MODULE_4__["default"])(this.element.querySelector('.event__input-start-time'), {
          ...
          onChange: _classPrivateFieldGet(this, _dateFromChange)
        }));
        ...
        _classPrivateFieldSet(this, _datepickerTo, (0,flatpickr__WEBPACK_IMPORTED_MODULE_4__["default"])(this.element.querySelector('.event__input-end-time'), {
          ...
          onChange: _classPrivateFieldGet(this, _dateToChange)
        }));
      }
    });

    _classPrivateFieldInitSpec(this, _dateFromChange, {
      writable: true,
      value: ([userDate]) => {
        this.updateData({
    ...
    _classPrivateFieldInitSpec(this, _dateToChange, {
      writable: true,
      value: ([userDate]) => {
        this.updateData({
    ...
    _classPrivateFieldInitSpec(this, _setInnerHandlers, {
      ...
      value: () => {
        ...
        this.element.querySelector('.event__input--price').addEventListener('change', _classPrivateFieldGet(this, _costChange));
      }
    });
    ...
    _classPrivateFieldInitSpec(this, _costChange, {
      writable: true,
      value: evt => {
        evt.preventDefault();
        this.updateData({
    ...
    _defineProperty(this, "setDeleteClick", callback => {
      this._callback.deleteClick = callback;
      this.element.querySelector('.event__reset-btn').addEventListener('click', _classPrivateFieldGet(this, _formDeleteClick));
    });

    _classPrivateFieldInitSpec(this, _formDeleteClick, {
      writable: true,
      value: evt => {
        evt.preventDefault();
    ...
    this._data = PointAddView.createEmptyPoint(_point);
...
_defineProperty(SiteAddNewPoint, "createEmptyPoint", () => {
  const offerArray = (0,_utils_offers_js__WEBPACK_IMPORTED_MODULE_2__.offersList)();
  const date = new Date();
  return {
    basePrice: null,
...
_defineProperty(SiteAddNewPoint, "parsePointToData", point => ({ ...point
}));

_defineProperty(SiteAddNewPoint, "parseDataToPoint", data => {
  const point = { ...data
  };
  return point;
});
...
/* harmony export */ });
/* harmony import */ var _utils_destinations_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/destinations.js */ "./src/utils/destinations.js");
/* harmony import */ var _utils_offers_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/offers.js */ "./src/utils/offers.js");
...
const createEditNewPointTemplate = point => {
  ...
  const waypointTypesMarkup = (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.createWaypointTypesMarkup)((0,_utils_offers_js__WEBPACK_IMPORTED_MODULE_1__.offersList)(), type);
  const destinationOptions = (0,_utils_destinations_js__WEBPACK_IMPORTED_MODULE_0__.destinations)().map(x => `<option value="${x.name}"></option>`).join('');
  const photosMarkup = destination.pictures.map(x => `<img class="event__photo" src="${x.src}" alt="${x.description}">`).join('');
  const editedOffersMarkup = (0,_utils_utils_js__WEBPACK_IMPORTED_MODULE_3__.createOffersSegmentMarkup)((0,_utils_offers_js__WEBPACK_IMPORTED_MODULE_1__.offersList)(), type);
  return `<li class="trip-events__item">
              <form class="event event--edit" action="#" method="post">
                <header class="event__header">
                  <div class="event__type-wrapper">
                  ...
                  <div class="event__field-group  event__field-group--destination">
                    ...
                    <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${he__WEBPACK_IMPORTED_MODULE_6___default().encode(destination.name)}" list="destination-list-1">
                    <datalist id="destination-list-1">
                      ${destinationOptions}
                    </datalist>
                  </div>
                  ...
                  <div class="event__field-group  event__field-group--price">
                    ...
                    <input class="event__input  event__input--price" id="event-price-1" type="text" name="event-price" value="${he__WEBPACK_IMPORTED_MODULE_6___default().encode(cost.toString())}">
                  </div>
                  <button class="event__save-btn  btn  btn--blue" type="submit">Save</button>
...
class SiteEditNewPoint extends _smart_view_js__WEBPACK_IMPORTED_MODULE_2__["default"] {
  constructor(_point) {
    super();
    ...
    _defineProperty(this, "reset", point => {
      this.updateData(SiteEditNewPoint.parsePointToData(point));
    });
    ...
    _classPrivateFieldInitSpec(this, _getChangedDestination, {
      writable: true,
      value: destinationName => {
        const allDestinations = (0,_utils_destinations_js__WEBPACK_IMPORTED_MODULE_0__.destinations)();
    ...
    this._data = SiteEditNewPoint.parsePointToData(_point);
...
const createFilterTemplate = (type, currentFilterType) => `<div class="trip-filters__filter">
...
const createFiltersTemplate = (filterItems, currentFilterType) => {
  const filterTemplate = filterItems.map(filter => createFilterTemplate(filter, currentFilterType)).join('');
...
class TripFiltersTemplate extends _view_site_abstract_class_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(filters, currentFilterType) {
    ...
    _defineProperty(this, "FilterTypeChangeHandler", callback => {
      this._callback.filterTypeChange = callback;
      this.element.addEventListener('change', _classPrivateFieldGet(this, _filterTypeChange));
    });
...
const createTripsSortTemplate = sortType => `<form class="trip-events__trip-sort  trip-sort" action="#" method="get">
...
class TripSortTemplate extends _view_site_abstract_class_view_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  get template() {
    return createTripsSortTemplate(_classPrivateFieldGet(this, _currentSortType));
  }
...
/* harmony import */ var _model_filter_model_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./model/filter-model.js */ "./src/model/filter-model.js");
...
const filterModel = new _model_filter_model_js__WEBPACK_IMPORTED_MODULE_6__["default"]();
...
const tripPresenter = new _presenter_trip_presenter_js__WEBPACK_IMPORTED_MODULE_4__["default"](pageBodyElement, pointsModel, filterModel);
const filterPresenter = new _presenter_filter_presenter_js__WEBPACK_IMPORTED_MODULE_2__["default"](tripFiltersElement, filterModel);
